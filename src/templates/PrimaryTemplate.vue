  ...
  <section class="primary-template">
    ...
    <nav class="top">
      <div class="logo-container">
        <a href="/home"><img src="../assets/the_basics_logo.png" alt=""/></a>
      </div>
    ...
    <footer>
      <div class="socials">
        ...
        <svg fill="#000000" width="50px" height="50px" viewBox="-2 -2 24 24" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin" class="jam jam-youtube-square">
